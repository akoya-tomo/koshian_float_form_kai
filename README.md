...
* 追加・修正された機能（KOSHIAN 返信フォームを固定 改）
  ...
  - ![\(New\)](images/new.png "New") ふたば標準の引用操作で返信フォームを表示  
    記事番号のプルダウンメニューからの引用操作や文字列選択の引用ポップアップボタン操作で返信フォームを表示します。  

## インストール
**GitHub**  
[![インストールボタン](images/install_button.png "クリックでアドオンをインストール")](https://github.com/akoya-tomo/koshian_float_form_kai/releases/download/v1.5.0/koshian_float_form_kai-1.5.0-fx.xpi)

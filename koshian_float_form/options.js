...
function saveOptions() {
  browser.storage.local.set({
    ...
    use_ime_control: document.querySelector("#use_ime_control").checked,
...
function setCurrentChoice(result) {
  ...
  document.querySelector("#use_ime_control").checked = safeGetValue(result.use_ime_control, DEFAULT_USE_IME_CONTROL);
